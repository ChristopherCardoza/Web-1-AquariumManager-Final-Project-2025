...
const config = {
  user: "EditorUser", // or "AdminUser" or "ViewerUser"
  password: "Editor123", // or 'Admin123' or 'Viewer123'
  server: "localhost",
  database: "FishManager", // Your database name
  options: {
    trustedConnection: false, // Set to false when using SQL authentication
    enableArithAbort: true,
    trustServerCertificate: true, // Allows self-signed certificates
    instancename: "SQLEXPRESS", // Remove this line if using default instance
  },
};
